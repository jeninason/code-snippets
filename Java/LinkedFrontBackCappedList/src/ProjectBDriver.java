...
public class ProjectBDriver {
	...
	public static void main(String[] args) {
		...
		runEmptyListTests(); //this works
		runAddToBackTests(); //this works
		runClearTests(); //this works
		runGetEntryTests(); //this works
//		runAddToFrontTests(); //this works
//		runContainsTests(); //this works
//		runIndexOfTests(); //this works
//		runLastIndexOfTests(); //this works
//		runRemovesTests();
